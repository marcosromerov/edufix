      ...
      <ScrollView contentContainerStyle={{ padding: 16, gap: 16, paddingBottom: 100 }}>
        <View className="items-center gap-2 pt-2">
          ...
          <View className="flex-row items-center gap-2">
            ...
            <View className="bg-status-progress/15 px-2 py-0.5 rounded-md">
              <Text className="text-status-progress text-[10px] font-bold uppercase">Operario</Text>
            </View>
          </View>
        ...
        <View className="flex-row gap-3">
          <View className="flex-1 bg-bg-card rounded-2xl py-4 items-center border border-border/40">
            <Text className="text-text text-2xl font-bold">{asignadas}</Text>
            <Text className="text-text-muted text-xs mt-1">Asignadas</Text>
          </View>
          <View className="flex-1 bg-bg-card rounded-2xl py-4 items-center border border-border/40">
          ...
          <View className="flex-1 bg-bg-card rounded-2xl py-4 items-center border border-border/40">
            <Text className="text-status-done text-2xl font-bold">{resueltas}</Text>
